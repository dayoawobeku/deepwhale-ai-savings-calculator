      ...
      <div className="w-full max-w-[619px] bg-white p-[60px] rounded-xl shadow-[0px_15px_48px_-20px_rgba(0,0,0,0.24)]">
        <div className="mt-4 flex flex-col items-center">
          ...
          <p className="mt-6 text-grey-700 font-medium max-w-[300px] text-center">
            Using {quantity} {quantity === 1 ? 'unit' : 'units'} of this service
            for
            <span className="block">
              {serviceUsage.value}{' '}
              {getDurationText(serviceUsage.unit, serviceUsage.value)} will save
              you ${savings}!
            </span>
          </p>
          ...
          <div className="flex flex-col gap-4 w-full">
            ...
            <div className="p-6 bg-white-900 flex items-center gap-2 rounded-lg">
              ...
              <div className="flex flex-col gap-1">
                <p className="text-grey-700 text-xs font-medium">TOTAL COST</p>
